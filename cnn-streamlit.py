...
def load_cnn1():
    model_ = load_model('C://Users/91770/tanishq-pneumonia-part-2/models/weights1.h5')
    return model_
...
def main():
 ...
 github.com/NazillyMada""")
    ...
    if choice == 1 :
        ...
        sample1 = Image.open('C://Users/91770/tanishq-pneumonia-part-2/sample/Capture.png')
        st.image(sample1,caption='Parasitized Cells', use_column_width=True)
        sample2 = Image.open('C://Users/91770/tanishq-pneumonia-part-2/sample/Capture1.png')
